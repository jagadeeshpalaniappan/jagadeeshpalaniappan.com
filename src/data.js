...
const navbarLinks = [
    { name: "Download My Resume", isExternalUrl: false, srcUrl: "https://raw.githubusercontent.com/jagadeeshpalaniappan/jagadeeshpalaniappan.github.io/master/jagadeesh-palaniappan-fullstack-dev.pdf", iconClassName: "fas fa-cloud-download-alt fa-2x" },
    { name: "LinkedIn", isExternalUrl: true, srcUrl: "https://www.linkedin.com/in/jagadeeshpalaniappan/", iconClassName: "fab fa-linkedin fa-2x", iconOnly: true },
    { name: "Github", isExternalUrl: true, srcUrl: "https://github.com/jagadeeshpalaniappan", iconClassName: "fab fa-github fa-2x", iconOnly: true },
    { name: "Facebook", isExternalUrl: true, srcUrl: "https://www.facebook.com/jagadeeshpalaniappan", iconClassName: "fab fa-facebook-square fa-2x", iconOnly: true },
    { name: "Call", isExternalUrl: true, srcUrl: "tel:+14085335628", iconClassName: "fas fa-phone-alt fa-2x", iconOnly: true }
];

const intro = {
    avatarUrl: "http://jagadeeshpalaniappan.github.io/assets/img/jag/hero1.jpg",
    name: "Jagadeesh Palaniappan",
    keywords: ["React Developer", "Angular.js Developer", "Node.js Developer", "Java-Spring Developer"],
    line1: <>I'm a passionate software developer and have more than <b>{getAge(new Date(2011, 8, 30))} years</b> of experience in building rich web
        applications.</>,
    line2Old: <>I'm a <b>full-stack developer</b> specialised in <b>frontend</b> and <b>backend</b> development for
        building complex scalable web apps</>,
    line2: <>I'm a <b>full-stack developer</b> starting from designing, developing (<b>Front-End</b> and <b>Back-End</b>)
        application, building and deploying them on Cloud </>
...
const workExp = {
    ...
    items: [
        ...
        {
            title: "Senior Software Engineer", description: "Tech Mahindra, Hyderabad",
...
const achievements = [
    {
        ...
        description: "I have developed a prototype to control Web Application using voice (Alexa / Google Home). This means you can natively talk and control web or mobile application.",
        srcUrl: "https://raw.githubusercontent.com/jagadeeshpalaniappan/jagadeeshpalaniappan.github.io/master/assets/jag/awards/ge/award2-learn-and-adapt-to-win.pdf"
    },
    {
        title: "Customers Determine Our Success (Award)",
        description: "there was a requirement from customer which is highly wanted which has been scheduled for Q1 release. " +
        ...
        srcUrl: "https://raw.githubusercontent.com/jagadeeshpalaniappan/jagadeeshpalaniappan.github.io/master/assets/jag/awards/ge/award1-customers-determine-our-success.pdf"
    },
    {
        title: "Customers Determine Our Success (Award)",
        description: "For troubleshooting and fix the Rasgas (one of our core customer) fixed the issues very quickly by steching my weekend holidays. As a result 'Customers' were happy with the real quick fix",
        srcUrl: "https://raw.githubusercontent.com/jagadeeshpalaniappan/jagadeeshpalaniappan.github.io/master/assets/jag/awards/ge/award3-customers-determine-our-success.pdf"
    },
];
...
const testimonials = [
    ...
    },
    {
        ...
        company: "ServiceNow",
        avatarUrl: "https://media.licdn.com/dms/image/C4E03AQGr90OM-Ba4WQ/profile-displayphoto-shrink_100_100/0?e=1572480000&v=beta&t=WSx-UXjsfmPZ0Z_lAjrjj_HepiuRU6v_kSKZElLbOUY",
        linkedInUrl: "",
        width: "700px",
        description: "Jagadeesh joined the APM Analysis team where I was the tech lead and had an immediate impact on the group’s productivity. He never balked at an assignment and in fact stepped up to do some side research on a new initiative around voice control of our interface. An eager learner, he quickly became one of the most valuable members of the staff. I thoroughly enjoyed working with him and hope our paths cross again."
    },
    {
        ...
        linkedInUrl: "",
        width: "700px",
        description: "\"SMAC\" is the first word that comes to my mind when I think of Jagadeesh. Jagadeesh has outstanding Technical and Analytical skills, He had been working for four years in Cisco Capital Projects. \n" +
...
const devSkills = [
    {
        title: <>Front-End: <small>(Web Development)</small></>,
        keywords: [
            {
                label: "React",
    ...
    {
        title: <>Back-End: <small>(Node.js Development)</small></>,
        keywords: [
            {
                label: "MEAN Stack ",
...
const leadershipSkills = {
    scrumMaster: [
        ...
        {
            label: "Organizing the sprint planning with team members and product owners and ensuring the team’s deleiverables.",
        },
        {
            label: "Constantly receiving feedbacks from team members during Sprint retrospective and work towards improvement.",
        }
    ],
    teamLead: [
        {
